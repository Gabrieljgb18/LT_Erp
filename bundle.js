...
var InvoicePanel = (function () {
    ...
    function ensureSelectOption_(selectEl, value) {
        ...
        const statusOptionsAll = buildStatusOptionsHtml_(true);
        const statusOptionsDefault = buildStatusOptionsHtml_(false, "Pendiente");
        const comprobanteOptions = buildComprobanteOptionsHtml_("Factura B");
